...
TF1* VarManager::fgModulationPsi2 = new TF1("fgModulationPsi2", "(x + 0.5*TMath::Pi() + 0.05/4.0*sin(4.0*x)) / TMath::Pi()", -0.5 * TMath::Pi(), 0.5 * TMath::Pi()); // Default modulation function for sampling random event plane with modulation
TF1* VarManager::fgModulationPsi3 = new TF1("fgModulationPsi3", "(x + 0.5*TMath::Pi() + 0.05/6.0*sin(6.0*x)) / TMath::Pi()", -0.5 * TMath::Pi(), 0.5 * TMath::Pi()); // Default modulation function for sampling random event plane with modulation
