...
TF1* VarManager::fgModulationPsi2 = new TF1("fgModulationPsi2", "(x + 0.5*TMath::Pi() + 0.05/4.0*sin(4*x)) / TMath::Pi()", -0.5 * TMath::Pi(), 0.5 * TMath::Pi()); // Default modulation function for sampling random event plane with modulation
